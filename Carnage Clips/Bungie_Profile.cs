...
{
    public class Bungie_Profile
    {
        public string Bungie_Display_Name { get; set; }
        public string Bungie_User_Code { get; set; }
        //This is the ID that goes direct to a bungie profile
        public string BunigeNet_Account_ID { get; set; }
        ...
        public List<Destiny_Character> Linked_Characters { get; set; }
        public List<AlternateAccounts> Alt_Accounts { get; set; }
        public List<Destiny_Weapon> MatchWeapons { get; set; }

        public List<DateTime> LinkedMatchTimes { get; set; }
        public List<Carnage_Report> LinkedMatches { get; set; }

        public class Destiny_Character
        {
            public string CharacterID { get; set; }

            public string EmblemLink { get; set; }
            ...
            public Bungie_Profile AccountOwner { get; set; }
        ...
        public class AlternateAccounts
        {
